//
//  WPApproveLoadPhotoController.m
//  WinShoppingMall
//
...
@interface WPApproveLoadPhotoController ()<UIImagePickerControllerDelegate,UIActionSheetDelegate, UINavigationControllerDelegate, UIScrollViewDelegate>
...
@implementation WPApproveLoadPhotoController
...
// 上传身份信息
- (void)pusIDCardnforData
{
    __weakSelf
    [WPHelpTool postWithURL:WPUserApproveIDCardURL parameters:self.idCardDic success:^(id success)
     {
         NSString *type = [NSString stringWithFormat:@"%@", success[@"type"]];
         if ([type isEqualToString:@"1"])
         {
             [weakSelf pushUserIDCardPhotoData];
         }

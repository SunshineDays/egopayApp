...
{
    NSString *fullName = [WPPublicTool stringHiddenWithString:self.approveModel.fullName headerIndex:1 footerIndex:0];
    NSString *userIDNmuber = [WPPublicTool stringHiddenWithString:[WPPublicTool base64DecodeString:self.approveModel.identityCard] headerIndex:3 footerIndex:2];
